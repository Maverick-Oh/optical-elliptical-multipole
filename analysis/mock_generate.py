...
def run_simulation():
    ...
    variations = {
        ...
        # 'background': [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05],
        # 'a_m3': [-0.03, -0.02, -0.01, -0.003, 0.003, 0.01, 0.02, 0.03],
        # 'a_m4': [-0.03, -0.02, -0.01, -0.003, 0.003, 0.01, 0.02, 0.03],
